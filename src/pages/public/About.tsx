  ...
  <div className="container py-16">
    <div className="max-w-3xl mx-auto text-center mb-14">
      ...
      <p className="text-muted-foreground mt-5 text-lg leading-relaxed">
        ون كليك منصة سحابية متخصصة في تقديم حلول محاسبية مرنة وسهلة للشركات الصغيرة والمتوسطة في العالم العربي. شعارنا بسيط: كل إجراء محاسبي يجب أن يتمّ بنقرة واحدة، حتى يتفرّغ أصحاب الأعمال لما يهم: تنمية أعمالهم.
      </p>
    </div>
