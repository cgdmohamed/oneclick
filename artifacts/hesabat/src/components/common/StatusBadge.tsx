...
const map: Record<string, { label: string; cls: string; dot: string }> = {
  ...
  draft:     { label: 'مسودة',         cls: 'bg-muted text-muted-foreground border-border',           dot: 'bg-muted-foreground' },
  cancelled: { label: 'ملغاة',         cls: 'bg-destructive/10 text-destructive border-destructive/30', dot: 'bg-destructive' },
