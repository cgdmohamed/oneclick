...
const fields = [
  ...
  ['sales_returns_account_id', 'Sales Returns', 'مرتجعات المبيعات / إشعارات دائنة'],
  ...
  ['fixed_assets_account_id', 'Fixed Assets', 'الأصول الثابتة'],
  ['accumulated_depreciation_account_id', 'Accumulated Depreciation', 'مجمع الإهلاك'],
  ['depreciation_expense_account_id', 'Depreciation Expense', 'مصروف الإهلاك'],
  ['asset_disposal_gain_loss_account_id', 'Gain/Loss on Asset Disposal', 'أرباح/خسائر التخلص من الأصل'],
  ['salaries_expense_account_id', 'Salaries Expense', 'مصروف الرواتب'],
  ['employee_payables_account_id', 'Employee Payables', 'رواتب مستحقة للموظفين'],
  ['social_insurance_payable_account_id', 'Social Insurance Payable', 'تأمينات اجتماعية مستحقة'],
  ['payroll_tax_payable_account_id', 'Payroll Tax Payable', 'ضريبة رواتب مستحقة'],
  ['payroll_deductions_payable_account_id', 'Payroll Deductions Payable', 'استقطاعات رواتب مستحقة'],
  ...
  ['inventory_loss_expense_account_id', 'Inventory Loss / Damaged Goods Expense', 'مصروف هالك / شطب المخزون'],
  ['bank_charges_expense_account_id', 'Bank Charges Expense', 'مصروفات بنكية'],
  ['interest_income_account_id', 'Interest Income', 'إيرادات فوائد بنكية'],
