...
app.use('/api/users', requireFeature('rbac'), usersRoutes);
app.use('/api/clients', requireFeature('clients'), clientsRoutes);
app.use('/api/products', requireFeature('products'), productsRoutes);
app.use('/api/categories', requireFeature('products'), categoriesRoutes);
app.use('/api/accounts', requireFeature('accounts'), accountsRoutes);
app.use('/api/invoices', requireFeature('invoices'), invoicesRoutes);
app.use('/api/payments', requireFeature('payments'), paymentsRoutes);
...
app.use('/api/payouts', requireFeature('payouts'), payoutsRoutes);
app.use('/api/stock-movements', requireFeature('stock_movements', 'products'), stockMovementsRoutes);
...
app.use('/api/invitations', requireFeature('rbac'), invitationsAdminRouter);
